...
function Hero() {
  return (
    <div className="text-slate-50 hero bg-gradient-to-tl from-slate-900 to-slate-700">
      <div className="max-w-[800px] mt-[-96] w-full min-h-screen mx-auto text-center flex flex-col justify-center">
        ...
        <div className="flex justify-center items-center">
          ...
          <Typed
            className="md:text-5xl sm:text-4xl text-xl font-bold text-slate-200"
            strings={[" candidates.", " developers.", " employees."]}
            typeSpeed={110}
            backSpeed={130}
            loop
          />
