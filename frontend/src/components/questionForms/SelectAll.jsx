    ...
    <div>
      <form className='flex flex-col space-y-4 mt-4 text-center items-center' onSubmit={handleSubmit}>
        <div className='flex flex-col space-y-2 md:w-[70%] w-[80%]'>
          ...
          />
          <label htmlFor='option1' className='text-slate-800 font-semibold text-left'>Option 1</label>
          <input
            ...
            className='border border-slate-800 rounded-md py-2 px-4 focus:outline-none focus:ring-1 focus:ring-slate-800 focus:border-transparent'
          />
          <label htmlFor='option2' className='text-slate-800 font-semibold text-left'>Option 2</label>
          <input
            ...
            className='border border-slate-800 rounded-md py-2 px-4 focus:outline-none focus:ring-1 focus:ring-slate-800 focus:border-transparent'
          />
          <label htmlFor='option3' className='text-slate-800 font-semibold text-left'>Option 3</label>
          <input
            ...
            className='border border-slate-800 rounded-md py-2 px-4 focus:outline-none focus:ring-1 focus:ring-slate-800 focus:border-transparent'
          />
          <label htmlFor='option4' className='text-slate-800 font-semibold text-left'>Option 4</label>
          <input
