    ...
    <div className="w-full py-16 px-4 shadow-lg bg-slate-200 mt-20">
      <div className="max-w-[1250px] mx-auto">
        ...
        <p className="text-slate-950">
          This privacy notice for Software Programming Quiz ("Company," "we,"
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            <Link to="/" className="underline">
              https://softwareprogrammingquiz.com
            </Link>
        ...
        <p className="text-slate-950">
          ...
          support@softwareprogrammingquiz.com.
        </p>
        <br />
        ...
        <p className="text-slate-950">
          ...
          please contact us at support@softwareprogrammingquiz.com.
        </p>
        <br />
        ...
        <br />
        <p className="text-slate-950 font-bold">Account Information</p>
        <br />
        <p className="text-slate-950">
        ...
        <p className="text-slate-950">
          ...
          email us at support@softwareprogrammingquiz.com.
        </p>
        <br />
        ...
        <p className="text-slate-950">
          ...
          <Link className="underline" to="/contact">
            https://softwareprogrammingquiz.com/contact
          </Link>
          .
        </p>
        <br />
