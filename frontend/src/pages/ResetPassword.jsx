      ...
      <div className='w-full flex items-center justify-center'>
        <div className='bg-slate-200 md:py-10 py-4 px-12 rounded-md shadow-lg m-10'>
          ...
          {submitted
            ?
            <div>
              <p className='font-medium text-lg text-slate-800 md:mt-3 mt-2'>Your password has be reset. </p>
              <Link to='/login'>
                Login 
              </Link>
            </div>
            ...
            <div>
              {failure
                ...
                :
                <p className='font-medium text-lg text-slate-800 md:mt-3 mt-2'>Reset your password below.</p>
              }
              <form className='mt-4' onSubmit={handleSubmit}>
                <div className='flex flex-col'>
                  <label className='text-slate-800 md:text-lg sm:text-base font-medium w-full' htmlFor="password">Password (minimum 6 characters)</label>
                  <input
                    type='password'
                  ...
                  <label className='text-slate-800 md:text-lg sm:text-base font-medium w-full mt-2' htmlFor="confirmPassword">Confirm Password</label>
                  <input
                    type='password'
                    className='w-full border-2 border-slate-300 text-slate-900 md:text-lg sm:text-base font-medium bg-slate-50 rounded p-1 px-2 mt-1'
                    placeholder='Enter your password'
