    ...
    <div className="w-full py-16 px-4 shadow-lg bg-slate-200 mt-20">
      <div className="max-w-[1250px] mx-auto">
        ...
        <p className="text-slate-950">
          We are Software Programming Quiz ("Company," "we," "us," or "our").
        </p>
        <br />
        <p className="text-slate-950">
          We operate the website https://softwareprogrammingquiz.com (the
        ...
        <p className="text-slate-950">
          ...
          Software Programming Quiz, concerning your access to and use of the
        ...
        <h1 className="text-slate-800 md:text-xl text-lg font-bold">
          1. OUR SERVICES
        </h1>
        <br />
        <p className="text-slate-950">
        ...
        <br />
        <p className="text-slate-950 font-bold">Our Intellectual Property</p>
        <br />
        <p className="text-slate-950">
        ...
        <br />
        <p className="text-slate-950 font-bold">Your use of our Services</p>
        <br />
        <p className="text-slate-950">
        ...
        <p className="text-slate-950">
          ...
          please address your request to: support@softwareprogrammingquiz.com.
        ...
        <p className="text-slate-950">
          ...
          <Link href="/privacy" className="underline">
            https://softwareprogrammingquiz.com/privacy
          </Link>
        ...
        <br />
        <p className="text-slate-950 font-bold">Informal Negotiations</p>
        <br />
        <p className="text-slate-950">
        ...
        <br />
        <p className="text-slate-950 font-bold">Binding Arbitration</p>
        <br />
        <p className="text-slate-950">
          ...
          rules or applicable law, the arbitration will take place in Los
          Angeles, California. Except as otherwise provided herein, the Parties
        ...
        <p className="text-slate-950 font-bold">Restrictions</p>
        <br />
        <p className="text-slate-950">
        ...
        <p className="text-slate-950">
          ...
          at support@softwareprogrammingquiz.com.
        </p>
        <br />
      </div>
    </div>
